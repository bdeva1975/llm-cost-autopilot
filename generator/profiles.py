...
class WorkloadProfile(BaseModel):
    ...
    daily_growth: float = Field(
        default=0.0, ge=-0.05, le=0.05, description="Compounding daily trend"
    )
...
PROFILES: list[WorkloadProfile] = [
    WorkloadProfile(
        ...
        requests_per_day=90,
        hourly_weights=BUSINESS_HOURS,
        weekend_factor=0.45,
        daily_growth=0.004,
        input_tokens_median=900,
        input_tokens_sigma=0.7,
        output_tokens_median=350,
    ...
    WorkloadProfile(
        ...
        weekend_factor=0.3,
        daily_growth=0.008,
        input_tokens_median=6000,
        input_tokens_sigma=0.4,
        output_tokens_median=400,
    ...
    WorkloadProfile(
        ...
        weekend_factor=0.35,
        daily_growth=0.003,
        input_tokens_median=2500,
        input_tokens_sigma=0.8,
        output_tokens_median=800,
        output_tokens_sigma=0.7,
    ...
    WorkloadProfile(
        ...
        requests_per_day=40,
        hourly_weights=NIGHT_BATCH,
        weekend_factor=1.0,
        daily_growth=0.0,
        input_tokens_median=3000,
        input_tokens_sigma=0.3,
        output_tokens_median=250,
        output_tokens_sigma=0.3,
