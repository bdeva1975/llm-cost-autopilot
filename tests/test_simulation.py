...
def test_full_reroute_exact_cost():
    ...
    r = simulate(
        ...
        [
            RouteAction(
                application="app-x", from_model="atlas-ultra", to_model="atlas-pro", fraction=1.0
            )
        ],
    )
...
def test_missing_traffic_warns():
    ...
    r = simulate(
        ...
        [
            RouteAction(
                application="app-x", from_model="rapids-xl", to_model="rapids-lite", fraction=0.5
            )
        ],
    )
    assert r.savings == pytest.approx(0.0)
...
def test_context_overflow_warns():
    ...
    r = simulate(
        ...
        [
            RouteAction(
                application="app-x", from_model="atlas-ultra", to_model="rapids-lite", fraction=1.0
            )
        ],
    )  # 16k window
...
def test_quality_and_latency_shift_direction():
    ...
    r = simulate(
        ...
        [
            RouteAction(
                application="app-x", from_model="atlas-ultra", to_model="atlas-mini", fraction=1.0
            )
        ],
    )
