...
MODEL_CATALOG: list[ModelSpec] = [
    ...
    ModelSpec(
        provider="acme", model="atlas-ultra", model_family="atlas", tier=QualityTier.FRONTIER,
        input_price_per_1m_tokens=15.0, output_price_per_1m_tokens=60.0,
        context_window=200_000, relative_quality=95, relative_latency=2.4,
    ),
    ModelSpec(
        provider="acme", model="atlas-pro", model_family="atlas", tier=QualityTier.MID,
        input_price_per_1m_tokens=3.0, output_price_per_1m_tokens=12.0,
        context_window=200_000, relative_quality=82, relative_latency=1.3,
    ),
    ModelSpec(
        provider="acme", model="atlas-mini", model_family="atlas", tier=QualityTier.SMALL,
        input_price_per_1m_tokens=0.15, output_price_per_1m_tokens=0.60,
        context_window=128_000, relative_quality=68, relative_latency=0.6,
    ),
    # --- borealis: mid-market provider ---
    ModelSpec(
        provider="borealis", model="polaris-large", model_family="polaris", tier=QualityTier.FRONTIER,
        input_price_per_1m_tokens=8.0, output_price_per_1m_tokens=24.0,
        context_window=128_000, relative_quality=88, relative_latency=1.9,
    ),
    ModelSpec(
        provider="borealis", model="polaris-small", model_family="polaris", tier=QualityTier.SMALL,
        input_price_per_1m_tokens=0.25, output_price_per_1m_tokens=1.25,
        context_window=64_000, relative_quality=70, relative_latency=0.7,
    ),
    # --- cascade: budget provider ---
    ModelSpec(
        provider="cascade", model="rapids-xl", model_family="rapids", tier=QualityTier.MID,
        input_price_per_1m_tokens=5.0, output_price_per_1m_tokens=15.0,
        context_window=128_000, relative_quality=80, relative_latency=1.5,
    ),
    ModelSpec(
        provider="cascade", model="rapids-base", model_family="rapids", tier=QualityTier.SMALL,
        input_price_per_1m_tokens=0.50, output_price_per_1m_tokens=1.50,
        context_window=32_000, relative_quality=72, relative_latency=0.9,
    ),
    ModelSpec(
        provider="cascade", model="rapids-lite", model_family="rapids", tier=QualityTier.SMALL,
        input_price_per_1m_tokens=0.10, output_price_per_1m_tokens=0.40,
        context_window=16_000, relative_quality=58, relative_latency=0.5,
    ),
]
